    ...
    <div ref={sectionRef} className="relative w-full min-h-screen flex items-start justify-center overflow-hidden px-4">
      ...
      >
        ...
        <p className="text-gray-700">
          My job experience involves me being a Large Group and 
          Small Group Tutor for Learning Support Services (LSS) at UCSC. 
          I have tutored dozens of students in Beginning Python (CSE 20) and 
          Discrete Mathematics (CSE 16). As a LSS Tutor, I hope to create an 
          inclusive and collaborative environment for undergraduate students to engage in their studies.
        </p>
      </motion.div>
    </div>
  );
